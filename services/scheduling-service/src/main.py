"""
Scheduling Service - Main Application Entry Point.
Handles appointment scheduling, availability management, and appointment lifecycle.
"""
...
from src.presentation.routers import appointments, availability
...
app = FastAPI(
    ...
    description="Appointment scheduling and availability management for Sistema Clínico",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc"
